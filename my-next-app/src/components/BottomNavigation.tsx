...
const BottomNavigation = () => {
  return (
    <div className="fixed bottom-0 w-full bg-[#151515] flex justify-around gap-2 py-4 px-3 pb-6 rounded-t-xl rounded-tr-xl h-[100px]">
      <button className="w-[20%] flex flex-col items-center justify-center bg-[#1c1c1c] p-1 py-2 rounded-md shahow">
      ...
      <button className="w-[20%] flex flex-col items-center justify-center bg-[#1c1c1c] p-1 py-2 rounded-md shahow border-[2px] border-orange">
