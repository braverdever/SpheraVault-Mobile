    ...
    <div className="max-h-screen flex flex-col bg-[#1c1c1c]"> {/* Added padding bottom */}
      ...
      <div className=" flex flex-col justify-center px-4 h-[40vh]">
        ...
        <ul className="list-disc list-inside mt-4 flex flex-col gap-2 list-disc-orange">
          <li className="text-[11px] text-white-7">Press &quot;SCAN HERE&quot; and tap the chip on your phone</li>
          <li className="text-[11px] text-white-7">Position the chip within the scanning frame</li>
          <li className="text-[11px] text-white-7">Move your device closer or farther away to get a clear focus</li>
        </ul>
